    ...
    match command:
        "fire":
            ...
            for i in 5:
                ...
                var projectile: TowerDefenseProjectile = fireComponent.CreateProjectile(0, dir * -300.0, "PeaDefault", TowerDefenseEnum.CHARACTER_COLLISION_FLAGS.GROUND_CHARACTRE, camp, Vector2.ZERO)
